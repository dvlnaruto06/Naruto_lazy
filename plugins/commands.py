...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💥 Movie Updates 💥', url=f"https://t.me/moviehub4u_update"),
            InlineKeyboardButton('🔔⚡ Search Group ⚡🤖', url='https://t.me/movie_group_bot_0')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Update Channel', url='https://t.me/moviehub4u_update')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
